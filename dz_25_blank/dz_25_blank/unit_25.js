...
function t4() {
    ...
    xhttp.open('GET', `http://getpost.itgid.info/index2.php?auth=${auth}&action=4&num1=1&num2=5`, true);
    xhttp.send();
}
...
function t10() {
    ...
    xhttp.open('POST', `http://getpost.itgid.info/index2.php?auth=${auth}&action=1`, true);
    
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');

    xhttp.send(`auth=${auth}&action=1`);
}
...
function t12() {
    ...
    xhttp.open('POST', `http://getpost.itgid.info/index2.php?auth=${auth}&action=3&num1=10&num2=100`, true);
...
function t14() {
    ...
    xhttp.open('POST', `http://getpost.itgid.info/index2.php?auth=${auth}&action=5`, true);
    
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');

    xhttp.send(`auth=${auth}&action=5`);
}
...
function t15() {
    ...
    xhttp.open('POST', `http://getpost.itgid.info/index2.php?auth=${auth}&action=6&num1=10&num2=100`, true);
    
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');

    xhttp.send(`auth=${auth}&action=6&num1=10&num2=100`);
}
