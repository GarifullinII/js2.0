...
// в данном случае конкатенация, сложение строки с числом.
...
function t9() {
    // получаем value внутри функции
    let inputI9 = document.querySelector('.i-9').value;
    // выводим в div.out-9 то, что пользователь ввел
    document.querySelector('.out-9').textContent = inputI9;
...
function t10() {
    // получаем value внутри функции
    let inputI10 = document.querySelector('.i-10').value;
    // выводим в div.out-10 то, что пользователь ввел, умноженное на 20
    document.querySelector('.out-10').textContent = inputI10 * 20;
}
...
function t11() {
    // получаем value внутри функции
    let inputI11 = document.querySelector('.i-11').value;
    // выводим в div.out-11 то, что пользователь ввел и добавляем к нему число 55
    document.querySelector('.out-11').textContent = inputI11 + 55;
}
...
function t12() {
    let inputName = document.querySelector('.i-12-1').value;
    let inputSurname = document.querySelector('.i-12-2').value;
    document.querySelector('.out-12').textContent = 'Hello ' + inputName + ' ' + inputSurname;
}
...
function t16() {
    let inputI61 = document.querySelector('.i-16-1').value;
    let inputI62 = document.querySelector('.i-16-2').value;
    document.querySelector('.out-16').textContent = inputI61 + inputI62;
}
