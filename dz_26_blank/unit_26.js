...
function t4() {
	fetch(`http://getpost.itgid.info/index2.php?auth=${auth}&action=4&num1=90&num2=99`, {
		method:'GET',
	})
	.then(response => response.text())
	.then(response => {
		document.querySelector('.out-4').innerHTML = response;
	})
}
...
.then(response => response.text())
.then(response => {
	document.querySelector('.out-5').innerHTML = response;
})
}
...
function t8() {
	...
	.then(response => response.text())
	.then(response => {
	document.querySelector('.out-8').innerHTML = response;
})
}
...
function t12() {
	...
	body: `auth=${auth}&action=3&num1=2&num2=8`
})
	.then(response => response.text())
	.then(response => {
